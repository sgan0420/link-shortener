...
# Solid Queue tables in the primary database — see docs/WIKI.md §2.8.
# Verbatim port of the gem's db/queue_schema.rb so the resulting schema
# matches what the multi-DB setup would have produced.
